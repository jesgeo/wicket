...
public class CustomerService {
	...
	private final HashMap<Long, Customer> contacts = new HashMap<Long, Customer>();
	...
	public void ensureTestData() {
		if (findAll().isEmpty()) {
			...
			for (String name : names) {
                ...
                int random = 0 - r.nextInt(365 * 15 + 365 * 60);
                c.setRegisterDate(LocalDate.now().plusDays(random));
				save(c);
			}
		}
	}
